    ...
    return (
        <section id="cta" className={sectionClasses}>
            ...
            <div className="relative">
              <h2 className="font-headline text-5xl md:text-7xl font-bold text-white" style={{ textShadow: '0 0 20px hsl(var(--primary) / 0.7)' }}>¿Listo para Ganar?</h2>
              <p className="mt-4 text-lg md:text-xl text-white/80 max-w-xl mx-auto">Únete a nuestra comunidad exclusiva en Telegram y no te pierdas ningún directo. La próxima gran victoria está a un clic de distancia.</p>

    ...
    return (
        <section id="cta" className={sectionClasses}>
            ...
            <div className="relative">
              <h2 className="font-headline text-5xl md:text-7xl font-bold text-white" style={{ textShadow: '0 0 20px hsl(var(--primary) / 0.7)' }}>¿Aún no has empezado a ganar?</h2>
              <p className="mt-4 text-lg md:text-xl text-white/80 max-w-xl mx-auto">Únete a una comunidad de jugadores que ya están ganando con nosotros.</p>

    ...
    return (
        <section id="cta" className="cta-section absolute inset-0 flex flex-col items-center justify-center opacity-0 text-center">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-lg md:text-xl text-white/80 max-w-xl mx-auto">Join a community of players who have transformed their game and elevated their strategy.</p>
